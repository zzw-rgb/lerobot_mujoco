"""
把本地采集的语言条件数据集（./demo_data_language）上传到 Hugging Face Hub。
...
运行方式：
    ...
    python vla/push_dataset_language.py
"""
...
# 不写用户名（比如只写 "franka_pnp_language"）也能传，Hub 会自动挂到当前登录账号名下，
# 但写全 "用户名/仓库名" 更清楚，建议改成你自己的用户名。
REPO_ID = 'a3124371940/franka_pnp_language'
